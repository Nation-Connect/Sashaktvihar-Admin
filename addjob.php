<?php
    ...
    {	
        ...
        $sql = "INSERT INTO job(title, short_desc, terms, status) VALUES('$title','$shortdesc','$terms','active')";
        
        
        
         if (mysqli_query($conn, $sql)) {
           
                  header("Location: http://admin.apbiharpower.in/job.php?status=success");
             
         } else {
              header("Location: http://admin.apbiharpower.in/job.php?status=failed");
