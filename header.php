        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="<?php if ($first_part=="tenderregistration.php") {echo "active-menu"; }?>" href="tenderregistration.php" class="notifyonclktender"><i class="fa fa-gavel" aria-hidden="true"></i>Tender Registration &nbsp;&nbsp;<span class="glyphicon not"><mark class="big swing"><span class="notifydata"></span></mark></span></a>
                    </li>
                    <li>
