            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                     ...
                     <li>
                        <a href="registration.php"><i class="fa fa-user-circle" aria-hidden="true"></i>Job Registration</a>
                    </li>
                    <li>
                    ...
                    <div class="col-md-9 col-sm-12 col-xs-12">
						...
						<div class="panel-body">
							<div id="morris-area-chart">
							   <iframe width="100%" height="250px" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vTw1SfNTR-IdC5IHLetksdk9tDAjjvopiqMUWQCy6N0imtRn0IiUEJDJcAY89x8i4SIF1kttFu7UsZ5/pubchart?oid=1018564876&amp;format=interactive"></iframe>	</div>
						</div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-12 col-xs-12">
