            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
					 ...
					 <li>
                        <a class="active-menu" href="#"><i class="fa fa-sitemap"></i> ONLINE APPLICATION <span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="active-menu" href="job.php">Job</a>
                            </li>
                            <li>
        ...
        <div id="page-wrapper">
		  <div class="header"> 
                        <h1 class="page-header">
                            Job Details<small>Manage Job</small>
                        </h1>
						<ol class="breadcrumb">
    ...
    <div class="alert alert-danger">
      ...
      <div class="alert-message text-left">
		...
		<div class="header"> 
            ...
            <a href="addjob.php"><button type="button" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> Add Job</button></a><br><br>
             <div class="jobdata">
                                                            ...
                                                            if ($result->num_rows > 0) {
                                                                ...
                                                                while($row = $result->fetch_assoc()) {
                                                                    echo '<div class="job-item" align="left"><div class="job-title"><h3>'.$row["title"].'</h3></div>
                                                                          ...
                                                                          <a href="jobedit.php?id='.$row["id"].'"><button class="btn btn-primary"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit </button></a>
                                                                          &nbsp;<button class="btn btn-danger" data-href="deletejob.php?id='.$row["id"].'" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash-o" aria-hidden="true"></i> Delete </button><br></div></div>';
                                                                }
                                                            } else {
