<?php
    ...
    {	
        ...
        $sql = "UPDATE job SET title = '$title',short_desc = '$shortdesc',terms = '$terms' WHERE id = $id";
        
        
         if (mysqli_query($conn, $sql)) {
           
                  header("Location: http://admin.apbiharpower.in/jobedit.php?status=success&id=$id");
             
         } else {
              header("Location: http://admin.apbiharpower.in/jobedit.php?status=failed&id=$id");
        ...
        <div id="page-wrapper">
		  <div class="header"> 
                        <h1 class="page-header">
                            Job Edit<small>Manage Job</small>
                        </h1>
						<ol class="breadcrumb">
